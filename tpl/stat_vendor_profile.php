...
if ($cacheStorage->checkContentValidByHash($cacheHash) && empty($_REQUEST["recache"])) {
    // Cache available!
    ...
    $strAmount = Translation::readTranslation("marketplace", "statistic.count.views", null, array(), "Aufrufe");
