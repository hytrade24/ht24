...
$param['SEARCH_FK_TYPE'] = 1;   // Bezug auf Anzeige
if (isset($_REQUEST['SEARCH_FK_CONTENT']) && $_REQUEST['SEARCH_FK_CONTENT'] != "") {
...
$numberOfChats = 0;
$chats = $chatManagement->fetchAllByParam($param, $numberOfChats);
$tplChat = array();
...
$tpl_content->addlist('liste', $tplChat, 'tpl/'.$s_lang.'/my-ad-msg.row.htm');

$additionalParams = $_GET;
unset($additionalParams['page']);

$pager = htm_browse_extended($numberOfChats, $npage, "my-ad-msg,".$modus.",{PAGE}", $perpage);
