...
// Load template
$tpl_content->LoadText("tpl/".$s_lang."/my-neu-msg.htm");
$tpl_content->addvar("USER_IS_VIRTUAL", 1);
// Replace url targets
$arUrlReplace = array("my-msg" => "user_msg", "my-neu-msg" => "user_msg_neu", "my-read-msg" => "user_msg_read");
foreach ($arUrlReplace as $identFrom => $identTo) {
    $nar_ident2nav[$identFrom] = $nar_ident2nav[$identTo];
}

require_once "my-neu-msg.php";
