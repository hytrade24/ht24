...
function UpdateList_Manufacturer(manufacturers) {
	...
	if (man_exact_name.length > 1) {
		...
		if (man_count > 0) {    
			...
			man_entry_desc.innerHTML = "<div class='div'><h3>Hersteller aus der Datenbank auswählen:</h3>"+
			    "Klicken Sie auf einen Hersteller aus der folgenden Liste, um diesen auszuwählen.</div>";
			...
			man_entry_desc = document.createElement("li");
			man_entry_desc.innerHTML = "<div class='div'><h3>Ihre Eingabe übernehmen:</h3>"+
				"Klicken Sie auf den folgenden, von ihnen eingegebenen, Hersteller um diesen auszuwählen.</div>";
			liste.appendChild(man_entry_desc);
            liste.appendChild(man_entry);
		}
	} else {
 			...
 			if (typeof(products) == "object") {
                ...
                var product_entry_desc;
 				if (products.length > 0) {
 			        ...
 			        product_entry_desc.innerHTML = "<div class='div'><h3>Produkt aus der Datenbank auswählen:</h3>"+
                       "Klicken Sie auf ein Produkt aus der folgenden Liste, um dieses auszuwählen.</div>";
 			        liste.appendChild(product_entry_desc);
 				} else {
 				   	product_entry_desc = document.createElement("li");
 				       product_entry_desc.innerHTML = "<div class='div'><h3>Ihre Eingabe übernehmen:</h3>"+
 				           "Klicken Sie auf das folgende, von ihnen eingegebenen, Produkt um dieses auszuwählen.</div>";
 				       liste.appendChild(product_entry_desc);
