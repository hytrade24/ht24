        ...
        success: function(response) {
            if(response.success == true) {
                ...
                if(response.like == true) {
                    $(buttonText).html("I don't like the ad");
                } else {
                    $(buttonText).html("I like this ad");
                }
            }
        }
    });
...
function TopAd(id_ad, runtime, bf_options) {
    ...
    ShowDialog(ebiz_trader_baseurl + "my-ad-top,"+id_ad+","+runtime+","+bf_options+".htm", "Book Top-Advertisement", 600, 480, {}, {}, function(dialog) {
