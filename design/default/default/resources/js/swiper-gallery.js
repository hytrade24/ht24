...
function swiperGallerySlider(elements, extraCss, swiperOptions) {
    ...
    var loading = 
        '<div class="design-gallery-loading-wrapper">' +
            '<div class="design-gallery-loading">' +
                '<div class="design-gallery-loading-text">' +
                    '<span class="design-gallery-loading-text-back">' +
                            '<img src="/cache/design/resources/de/images/logo.png" alt="[[ translation : marketplace : start.teaser.loading :: Wird geladen... ]]">' +
            ...
            '</div>' +
        '</div>';
    var buttonsAbsolute = '<a data-action="close">[[ translation : general : gallery.slider.close :: Schließen ]]</a>';
    var buttonsLeft = '';
    var buttonsRight = '';
    if (index > 1) {
        buttonsLeft =
            '<div class="visible-desktop">' +
                '<a data-action="prevSlide" class="btn btn-default">[[ translation : general : gallery.slider.back :: Vorheriges Bild ]]</a> ' +
            '</div>';
        buttonsRight =
            '<div class="visible-desktop">' +
                '<a data-action="nextSlide" class="btn btn-default">[[ translation : general : gallery.slider.forward :: Nächstes Bild ]]</a>' +
            '</div>';
    }
    html =
