...
var ImportPresetEditor = function (selector, params) {
	...
	this.showDataFieldTable = function(markerCol) {
		ShowDialog(ebiz_trader_baseurl + 'index.php?page=my-import-presets-edit&DO=SHOW_DATAFIELD_TABLE&MARKER_COL='+markerCol, '[[ translation : marketplace : import.preset.editor.datafieldtable.header :: Import Daten ]]', '1000', '700');
	}
