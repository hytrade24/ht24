...
this.imgURL = _editor_url + 'admin/gfx/';
this.debug  = 0;
...
function editor_action(button_id) {
  ...
  // commandID and pass it to execCommand().   See http://msdn.microsoft.com/workshop/author/dhtml/reference/commandids.asp
    ...
    // insert image
      ...
      showModalDialog(_editor_url + "popups/insert_image.php?ns="+_nav_imgsel+"&np="+_nav_imgput+"&url="+(_editor_url ? 'admin/':''), editdoc, "resizable: yes; help: no; status: no; scroll: no; width: 640; height:480;");
    }
