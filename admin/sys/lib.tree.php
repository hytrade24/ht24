...
function pathicon($path)
{
  if (PATHICOWITHGD)
  {
    ...
    $src = "path.$path.png";
  return '
  <td width="19" height="17"><img src="gfx/'. $src. '" width="19" height="17"></td>';
}

function tree_fetch(&$ar_data, $s_table = 'nav', $s_where='1', $s_pos='`POS`')
{
  global $db, $langval,
...
#  $s_dir =
  if ($nar_children[$parent]) foreach($nar_children[$parent] as $i=>$id)
  {
