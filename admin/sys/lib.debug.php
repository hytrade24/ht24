...
/**
* puffert die Ausgabe von var_dump und entfernt Ã¼berflÃ¼ssige ZeilenumbrÃ¼che (diejenigen hinter =>)
*
* @param mixed $var
* @return string
*/
...
/**
* gibt eine Liste Ã  la ebiz_db::fetch_table (siehe lib.db) tabellarisch aus
*
