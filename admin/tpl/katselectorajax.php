...
/* ###VERSIONSBLOCKINLCUDE### */
 ...
 $tpl_content->addlist("liste", $baum->ar_baum, "tpl/de/katselector.row.htm");
 ...
 $tpl_content->addlist("ariane", array_reverse($baum->ar_path_all), "tpl/de/katselector.ariane.htm");
