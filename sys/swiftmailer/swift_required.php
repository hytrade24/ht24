...
// WORKAROUND FOR HYDROMOT

require_once __DIR__."/../../ebiz-kernel/vendor/autoload.php";
require_once __DIR__."/../../ebiz-kernel/vendor/swiftmailer/swiftmailer/lib/swift_required.php";
return;
