...
require_once $ab_path."sys/packet_order/targets/membership.php";

class PacketOrderMembershipRecurring extends PacketOrderCollectionRecurring {
	...
	*/
	...
	public function activate() {
        ...
        if(($this->getPaymentDateLast() == NULL) || strtotime($this->getPaymentDateLast()) >= time()) {
    ...
    /**
     * @see PacketOrderRecurring::cancelNow()
     */
