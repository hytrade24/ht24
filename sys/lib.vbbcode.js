...
c_help = "Code anzeigen: [code]Code[/code]";
l_help = "Liste: [list]Text[/list]";
o_help = "Neue Seite anfangen: [pagebreak]";
p_help = "Bild einfügen: [img]http://URL_des_Bildes[/img] ";
w_help = "URL einfügen: [url]http://URL[/url] oder [url=http://url]URL Text[/url]";
...
f_help = "Schriftgröße: [size=7]Kleiner Text[/size]";

// Define the bbCode tags
bbcode = new Array();
bbtags = new Array('[b]','[/b]','[i]','[/i]','[u]','[/u]','[quote]','[/quote]','[code]','[/code]','[list]','[/list]','[pagebreak]','','[img]','[/img]','[url]','[/url]');
imageTag = false;
...
function bbPicInsert(insert) {
	var txtarea = document.post.text;
	txtarea.focus();
	txtarea.value = txtarea.value + " " + insert + " ";
}