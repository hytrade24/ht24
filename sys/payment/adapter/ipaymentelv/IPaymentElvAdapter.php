...
class Payment_Adapter_IPaymentElv_IPaymentElvAdapter extends Payment_Adapter_AbstractPaymentAdapter {
    protected $api = NULL;
    ...
    public function prepare() {
        ...
        $tpl->addvar('URL_HIDDENTRIGGER', $nar_systemsettings['SITE']['SITEURL'].$nar_systemsettings['SITE']['BASE_URL'].'sys/payment/adapter/ipaymentelv/lib/verify.php');
